...
function getMonitoredValue(props) {
  const { filters, selectedFilterKey } = props;
  ...
  render() {
    ...
    return (
      <PageContent title={translate('Missing')}>
        <PageToolbar>
          <PageToolbarSection>
            ...
            <PageToolbarButton
              label={
                isShowingMonitored
                  ? translate('IsShowingMonitoredUnmonitorSelected')
                  : translate('IsShowingMonitoredMonitorSelected')
              }
              iconName={
                isShowingMonitored ? icons.UNMONITORED : icons.MONITORED
              }
          ...
          <PageToolbarSection alignContent={align.RIGHT}>
            <TableOptionsModalWrapper {...otherProps} columns={columns}>
              <PageToolbarButton
        ...
        <PageContentBody>
          {isAnyFetching && !isAllPopulated && <LoadingIndicator />}

          {!isAnyFetching && error && (
            <Alert kind={kinds.DANGER}>Error fetching missing items</Alert>
          )}

          {isAllPopulated && !error && !items.length && (
            <Alert kind={kinds.INFO}>{translate('NoMissingItems')}</Alert>
          )}
            ...
            <div>
              ...
              <ConfirmModal
                ...
                message={
                  <div>
                    <div>
                      {translate('SearchForAllMissingAlbumsConfirmationCount', {
                        totalRecords,
                      })}
                    </div>
