    ...
    return (
      <PageContent title={translate('CutoffUnmet')}>
        ...
        <PageContentBody>
          ...
          {!isAnyFetching && error && (
            <Alert kind={kinds.DANGER}>Error fetching cutoff unmet</Alert>
          )}

          {isAllPopulated && !error && !items.length && (
            <Alert kind={kinds.INFO}>{translate('NoCutoffUnmetItems')}</Alert>
          )}
              ...
              <ConfirmModal
                ...
                message={
                  <div>
                    <div>
                      {translate(
                        'SearchForAllCutoffUnmetAlbumsConfirmationCount',
                        { totalRecords }
                      )}
                    </div>
