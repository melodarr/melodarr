...
class ArtistDetails extends Component {
  ...
  render() {
    ...
    const { trackFileCount = 0, sizeOnDisk = 0 } = statistics;
      ...
      <PageContent title={artistName}>
        <PageToolbar>
            ...
            <PageToolbarButton
              ...
              title={
                hasMonitoredAlbums
                  ? undefined
                  : translate(
                      'HasMonitoredAlbumsNoMonitoredAlbumsForThisArtist'
                    )
              }
          ...
          <PageToolbarSection alignContent={align.RIGHT}>
            <PageToolbarButton
              label={
                allExpanded
                  ? translate('AllExpandedCollapseAll')
                  : translate('AllExpandedExpandAll')
              }
              iconName={expandIcon}
        ...
        <PageContentBody innerClassName={styles.innerContentBody}>
            ...
            <div className={styles.headerContent}>
              ...
              <div className={styles.info}>
                ...
                <div className={styles.details}>
                  <div>
                    <HeartRating rating={ratings.value} iconSize={20} />
                ...
                <div className={styles.detailsLabels}>
                  ...
                  <Tooltip
                    ...
                    tooltip={<span>{trackFilesCountMessage}</span>}
                    kind={kinds.INVERSE}
                    position={tooltipPositions.BOTTOM}
                  />
          ...
          <div className={styles.metadataMessage}>
            ...
            or manually
            <Link to={`/add/search?term=${encodeURIComponent(artistName)}`}>
              {' '}
              Search{' '}
            </Link>
            for new items!
