    ...
    return (
      <TableRow>
        {columns.map((column) => {
          ...
          if (name === 'mediumCount') {
            return <TableRowCell key={name}>{mediumCount}</TableRowCell>;
          }
          ...
          if (name === 'trackCount') {
            return <TableRowCell key={name}>{totalTrackCount}</TableRowCell>;
          }

          if (name === 'duration') {
            return (
              <TableRowCell key={name}>{formatTimeSpan(duration)}</TableRowCell>
            );
          }
          ...
          if (name === 'rating') {
            return (
              <TableRowCell key={name}>
                {<StarRating rating={ratings.value} votes={ratings.votes} />}
              </TableRowCell>
            );
          }
