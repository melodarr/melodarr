...
export const defaultState = {
  ...
  sortPredicates: {
    age: function (item, _direction) {
      return item.ageMinutes;
    },
    peers: function (item, _direction) {
      const seeders = item.seeders || 0;
      const leechers = item.leechers || 0;

      return seeders * 1000000 + leechers;
    },
    rejections: function (item, _direction) {
...
export const actionHandlers = handleThunks({
  ...
  [CANCEL_FETCH_RELEASES]: function (_getState, _payload, _dispatch) {
...
export const reducers = createHandleActions(
  {
    ...
    [SET_ALBUM_RELEASES_FILTER]:
      createSetClientSideCollectionFilterReducer(albumSection),
    [SET_ARTIST_RELEASES_FILTER]:
      createSetClientSideCollectionFilterReducer(artistSection),
  },
  defaultState,
  section
);
