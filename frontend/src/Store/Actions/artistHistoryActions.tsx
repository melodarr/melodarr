...
export const ARTIST_HISTORY_MARK_AS_FAILED =
  'artistHistory/artistHistoryMarkAsFailed';
...
export const artistHistoryMarkAsFailed = createThunk(
  ARTIST_HISTORY_MARK_AS_FAILED
);
...
export const actionHandlers = handleThunks({
  ...
  [ARTIST_HISTORY_MARK_AS_FAILED]: function (getState, payload, dispatch) {
    const { historyId, artistId, albumId } = payload;
