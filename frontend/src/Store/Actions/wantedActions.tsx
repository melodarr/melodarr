...
export const BATCH_TOGGLE_MISSING_ALBUMS =
  'wanted/missing/batchToggleMissingAlbums';
...
export const BATCH_TOGGLE_CUTOFF_UNMET_ALBUMS =
  'wanted/cutoffUnmet/batchToggleCutoffUnmetAlbums';
...
export const batchToggleMissingAlbums = createThunk(
  BATCH_TOGGLE_MISSING_ALBUMS
);
...
export const batchToggleCutoffUnmetAlbums = createThunk(
...
export const actionHandlers = handleThunks({
  ...
  [BATCH_TOGGLE_MISSING_ALBUMS]: createBatchToggleAlbumMonitoredHandler(
    'wanted.missing',
    fetchMissing
  ),
