...
function fetchDataAugmenter(getState, payload, data) {
  data.includeUnknownArtistItems =
    getState().queue.options.includeUnknownArtistItems;
}
...
export const actionHandlers = handleThunks({
  ...
  [REMOVE_QUEUE_ITEM]: function (getState, payload, dispatch) {
    const { id, removeFromClient, blocklist, skipRedownload, changeCategory } =
      payload;
  ...
  [REMOVE_QUEUE_ITEMS]: function (getState, payload, dispatch) {
    const { ids, removeFromClient, blocklist, skipRedownload, changeCategory } =
      payload;
