...
export const RESTART_DB = 'system/restartDb';
...
export const restartDb = createThunk(RESTART_DB);
...
export const actionHandlers = handleThunks({
  ...
  [FETCH_INSTALLED_PLUGINS]: createFetchHandler(
    'system.plugins',
    '/system/plugins'
  ),
  ...
  [RESTART_DB]: function (getState, payload, dispatch) {
    const promise = createAjaxRequest({
      url: '/system/restartdb',
      method: 'POST',
    }).request;
...
export const reducers = createHandleActions(
  {
    [CLEAR_RESTORE_BACKUP]: function (state, { payload: _payload }) {
      return {
        ...state,
        backups: {
          ...state.backups,
