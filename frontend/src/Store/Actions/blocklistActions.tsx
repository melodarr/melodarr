...
export const GOTO_PREVIOUS_BLOCKLIST_PAGE =
  'blocklist/gotoBlocklistPreviousPage';
...
export const gotoBlocklistPreviousPage = createThunk(
  GOTO_PREVIOUS_BLOCKLIST_PAGE
);
