...
export const ALBUM_HISTORY_MARK_AS_FAILED =
  'albumHistory/albumHistoryMarkAsFailed';
...
export const albumHistoryMarkAsFailed = createThunk(
  ALBUM_HISTORY_MARK_AS_FAILED
);
...
export const actionHandlers = handleThunks({
  ...
  [ALBUM_HISTORY_MARK_AS_FAILED]: function (getState, payload, dispatch) {
    const { historyId, albumId } = payload;
