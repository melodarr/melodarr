...
export const defaultState = {
  ...
  sortPredicates: {
    path: function (item, _direction) {
      const path = item.path;

      return naturalExpansion(path.toLowerCase());
    },

    artist: function (item, _direction) {
      const artist = item.artist;

      return artist ? artist.sortName : '';
    },

    quality: function (item, _direction) {
...
export const FETCH_INTERACTIVE_IMPORT_TRACKFILES =
  'interactiveImport/fetchInteractiveImportTrackFiles';
export const CLEAR_INTERACTIVE_IMPORT_TRACKFILES =
  'interactiveImport/clearInteractiveImportTrackFiles';
...
export const saveInteractiveImportItem = createThunk(
  SAVE_INTERACTIVE_IMPORT_ITEM
);
...
export const fetchInteractiveImportTrackFiles = createThunk(
  FETCH_INTERACTIVE_IMPORT_TRACKFILES
);
export const clearInteractiveImportTrackFiles = createAction(
  CLEAR_INTERACTIVE_IMPORT_TRACKFILES
);
...
export const actionHandlers = handleThunks({
  ...
  [FETCH_INTERACTIVE_IMPORT_TRACKFILES]: createFetchHandler(
    trackFilesSection,
    '/trackFile'
  ),
});
