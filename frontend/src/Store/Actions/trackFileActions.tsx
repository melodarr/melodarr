...
export const persistState = ['trackFiles.sortKey', 'trackFiles.sortDirection'];
...
export const SET_TRACK_FILES_TABLE_OPTION =
  'trackFiles/setTrackFilesTableOption';
...
export const setTrackFilesTableOption = createAction(
  SET_TRACK_FILES_TABLE_OPTION
);
...
export const actionHandlers = handleThunks({
  ...
  [DELETE_TRACK_FILE]: function (getState, payload, dispatch) {
    const { id: trackFileId, albumEntity = albumEntities.ALBUMS } = payload;
  ...
  [UPDATE_TRACK_FILES]: function (getState, payload, dispatch) {
    const { trackFileIds, quality } = payload;
