...
const black = '#020617'; // Slate 950
const white = '#f8fafc'; // Slate 50
const offWhite = '#f1f5f9'; // Slate 100
const purple = '#7a43b6';
const pink = '#ff69b4';
const lightGray = '#ddd';
...
export default {
  ...
  themeAlternateBlue: '#10b981', // Emerald 500
  themeRed: '#ef4444', // Red 500
  themeDarkColor: '#1e293b', // Slate 800
  themeLightColor: '#64748b', // Slate 500
  pageBackground: '#0f172a', // Slate 900
  pageFooterBackground: 'rgba(2, 6, 23, 0.5)',
  ...
  // Header
  pageHeaderBackgroundColor: 'rgba(15, 23, 42, 0.75)', // Glassmorphic slate 900

  // Sidebar

  sidebarColor: '#94a3b8',
  sidebarBackgroundColor: '#0f172a',
  sidebarActiveBackgroundColor: '#1e293b',

  // Toolbar
  toolbarColor: '#94a3b8',
  toolbarBackgroundColor: '#020617', // Slate 950
  toolbarMenuItemBackgroundColor: '#1e293b',
  toolbarMenuItemHoverBackgroundColor: '#334155',
  toolbarLabelColor: '#f1f5f9',
  ...
  defaultBackgroundColor: '#334155', // Slate 700
  defaultBorderColor: '#475569', // Slate 600
  defaultHoverBackgroundColor: '#475569',
  defaultHoverBorderColor: '#64748b',

  primaryBackgroundColor: '#10b981', // Emerald 500
  primaryBorderColor: '#059669',
  primaryHoverBackgroundColor: '#059669', // Emerald 600
  primaryHoverBorderColor: '#047857',
  ...
  modalBackdropBackgroundColor: 'rgba(2, 6, 23, 0.75)', // Slate 950 overlay
  modalBackgroundColor: '#1e293b', // Slate 800
  modalCloseButtonHoverColor: '#cbd5e1',
  ...
  cardAlternateBackgroundColor: '#1e293b',
  cardCenterBackgroundColor: '#0f172a', // Slate 900
  ...
  inputBackgroundColor: '#334155', // Slate 700
  inputReadOnlyBackgroundColor: '#1e293b', // Slate 800
  inputHoverBackgroundColor: '#475569', // Slate 600
  inputSelectedBackgroundColor: '#64748b', // Slate 500
  advancedFormLabelColor: '#f59e0b', // Amber 500
  disabledCheckInputColor: '#64748b',
  disabledInputColor: '#475569',
  ...
  calendarTodayBackgroundColor: '#334155',
  calendarBackgroundColor: '#1e293b',
  calendarBorderColor: '#475569',
  calendarTextDim: '#94a3b8',
  calendarTextDimAlternate: '#f8fafc',
