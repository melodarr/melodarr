...
import styles from './AddNewArtistSearchResult.module.css';
...
class AddNewArtistSearchResult extends Component {
  ...
  render() {
    ...
    const { isNewAddArtistModalOpen } = this.state;

    const linkProps = isExistingArtist
        ...
        <div className={styles.overlay}>
          ...
          <div className={styles.content}>
            ...
            <div>
              ...
              {artistType ? (
                <Label size={sizes.LARGE}>{artistType}</Label>
              ) : null}
