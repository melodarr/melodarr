            ...
            !isFetching && !error && !items.length && !!term &&
              <div className={styles.message}>
                ...
                <div>
                  ...
                  of an artist or release group e.g. lidarr:cc197bad-dc9c-440d-a5b5-d52ba2e14234 {/* TODO: Update 'lidarr:' search prefix in backend SkyHookProxy.cs first */}
                </div>
              </div>
          }
            ...
            term ?
              ...
              <div className={styles.message}>
                ...
                <div>
                  You can also search using the
                  <Link to="https://musicbrainz.org/search"> MusicBrainz ID </Link>
                  of an artist e.g. lidarr:cc197bad-dc9c-440d-a5b5-d52ba2e14234 {/* TODO: Update 'lidarr:' search prefix in backend SkyHookProxy.cs first */}
                </div>
              </div>
          }
