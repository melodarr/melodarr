...
import AddArtistOptionsForm from '../Common/AddArtistOptionsForm';
import styles from './AddNewAlbumModalContent.module.css';
  ...
  render() {
    ...
    return (
      <ModalContent onModalClose={onModalClose}>
        <ModalHeader>{translate('AddNewAlbum')}</ModalHeader>
        ...
        <ModalBody>
          <div className={styles.container}>
            ...
            <div className={styles.info}>
              <div className={styles.name}>{albumTitle}</div>

              {!!disambiguation && (
                <span className={styles.disambiguation}>
                  ({disambiguation})
                </span>
              )}
