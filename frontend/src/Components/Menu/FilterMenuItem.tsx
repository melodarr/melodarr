...
class FilterMenuItem extends Component {
  ...
  onPress = () => {
    const { filterKey, onPress } = this.props;
  ...
  render() {
    const { filterKey, selectedFilterKey, ...otherProps } = this.props;
...
FilterMenuItem.propTypes = {
  filterKey: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
    .isRequired,
