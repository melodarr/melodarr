...
class PageConnector extends Component {
  ...
  render() {
    console.log(
      'PageConnector is rendering!',
      this.props.isPopulated,
      this.props.hasError,
      this.state.isLocalStorageSupported
    );
    const {
      isPopulated,
      hasError,
      _dispatchFetchArtist,
      _dispatchFetchTags,
      _dispatchFetchLanguages,
      _dispatchFetchQualityProfiles,
      _dispatchFetchMetadataProfiles,
      _dispatchFetchImportLists,
      _dispatchFetchIndexerFlags,
      _dispatchFetchUISettings,
      _dispatchFetchStatus,
      _dispatchFetchTranslations,
      ...otherProps
    } = this.props;

    if (hasError || !this.state.isLocalStorageSupported) {
      return <ErrorPage {...this.state} {...otherProps} />;
    }

    if (isPopulated) {
      return <Page {...otherProps} onSidebarToggle={this.onSidebarToggle} />;
    }
