  ...
  render() {
    ...
    return (
      <ModalContent onModalClose={onModalClose}>
        <ModalHeader>File Browser</ModalHeader>
        ...
        >
            ...
            <Alert className={styles.mappedDrivesWarning} kind={kinds.WARNING}>
              <InlineMarkdown
                data={translate('MappedNetworkDrivesWindowsService', {
                  url: 'https://github.com/melodarr/melodarr/wiki',
                })}
              />{' '}
          ...
          >
            {!!error && <div>{translate('ErrorLoadingContents')}</div>}
        ...
        <ModalFooter>
          ...
          <Button onPress={this.onOkPress}>{translate('Ok')}</Button>
        </ModalFooter>
      </ModalContent>
    );
  }
