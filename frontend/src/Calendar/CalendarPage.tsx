...
class CalendarPage extends Component {
  ...
  onSearchMissingPress = () => {
    const { missingAlbumIds, onSearchMissingPress } = this.props;
  ...
  render() {
    ...
    const { isCalendarLinkModalOpen, isOptionsModalOpen } = this.state;
    ...
    return (
      <PageContent title={translate('Calendar')}>
        ...
        >
          {artistIsFetching && !artistIsPopulated && <LoadingIndicator />}
          ...
          {!artistError && artistIsPopulated && hasArtist && (
            <Measure whitelist={['width']} onMeasure={this.onMeasure}>
              {isMeasured ? (
                <CalendarConnector useCurrentPage={useCurrentPage} />
              ) : (
                <div />
              )}
            </Measure>
          ...
          {!artistError && artistIsPopulated && !hasArtist && <NoArtist />}

          {hasArtist && !!artistError && <LegendConnector />}
        </PageContentBody>
