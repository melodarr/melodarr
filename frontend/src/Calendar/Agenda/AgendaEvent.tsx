...
class AgendaEvent extends Component {
  ...
  render() {
    ...
    const statusStyle = getStatusStyle(
      ...
      startTime,
      isMonitored,
      statistics.percentOfTracks
    );

    return (
      <div>
        <Link className={styles.event} component="div" onPress={this.onPress}>
          ...
          <div className={styles.albumTitle}>
            <Link to={`/album/${foreignAlbumId}`}>{title}</Link>
          </div>

          {!!queueItem && <CalendarEventQueueDetails {...queueItem} />}
