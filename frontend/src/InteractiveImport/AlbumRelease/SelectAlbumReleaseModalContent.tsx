...
import styles from './SelectAlbumReleaseModalContent.module.css';
...
class SelectAlbumReleaseModalContent extends Component {
  ...
  render() {
    const { albums, onAlbumReleaseSelect, onModalClose, ...otherProps } =
      this.props;
    ...
    return (
      <ModalContent onModalClose={onModalClose}>
        ...
        >
          <Alert>
            Overriding a release here will{' '}
            <b>disable automatic release selection</b> for that album in future.
          </Alert>
