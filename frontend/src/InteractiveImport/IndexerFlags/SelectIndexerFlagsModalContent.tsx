...
class SelectIndexerFlagsModalContent extends Component {
  ...
  render() {
    ...
    const { indexerFlags } = this.state;

    return (
      <ModalContent onModalClose={onModalClose}>
        <ModalHeader>Manual Import - Set indexer Flags</ModalHeader>
        ...
        <ModalFooter>
          ...
          <Button kind={kinds.SUCCESS} onPress={this.onIndexerFlagsSelect}>
