  ...
  render() {
    ...
    return (
      <PageContent title={translate('GeneralSettings')}>
        <SettingsToolbarConnector {...otherProps} />
        ...
        <ConfirmModal
          ...
          message={`Melodarr requires a restart to apply changes, do you want to restart now? ${
            isWindowsService
              ? 'Depending which user is running the Melodarr service you may need to restart Melodarr as admin once before the service will start automatically.'
              : ''
          }`}
