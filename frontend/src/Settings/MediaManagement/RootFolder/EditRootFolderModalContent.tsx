...
import styles from './EditRootFolderModalContent.module.css';
  ...
  return (
    <ModalContent onModalClose={onModalClose}>
      ...
      <ModalBody>
        ...
        {!isFetching && !!error && (
          <div>{translate('UnableToAddANewRootFolderPleaseTryAgain')}</div>
        )}
        ...
        {!isFetching && !error && (
          <Form {...otherProps}>
            ...
            <FormGroup>
              <FormLabel>{translate('DefaultLidarrTags')}</FormLabel>
