...
const fileNameTokens = [
  {
    token:
      '{Artist Name} - {Album Title} - {track:00} - {Track Title} {Quality Full}',
    example: 'Artist Name - Album Title - 01 - Track Title MP3-320 Proper',
  },
  {
    token:
      '{Artist.Name}.{Album.Title}.{track:00}.{TrackClean.Title}.{Quality.Full}',
...
const releaseDateTokens = [{ token: '{Release Year}', example: '2016' }];
...
const trackArtistTokens = [
  ...
  {
    token: '{Track ArtistMbId}',
    example: 'db92a151-1ac2-438b-bc43-b82e149ddd50',
  },
];
...
const originalTokens = [
  {
    ...
    example: 'Artist.Name.Album.Name.2018.FLAC-EVOLVE',
  },
...
class NamingModal extends Component {
  ...
  render() {
    ...
    const { separator: tokenSeparator, case: tokenCase } = this.state;
