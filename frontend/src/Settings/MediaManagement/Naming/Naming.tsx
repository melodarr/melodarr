...
class Naming extends Component {
  ...
  render() {
    ...
    const { isNamingModalOpen, namingModalOptions } = this.state;
    ...
    const colonReplacementOptions = [
      ...
      { key: 3, value: translate('ReplaceWithSpaceDashSpace') },
      {
        ...
        hint: translate('DashOrSpaceDashDependingOnName'),
      },
    ];
    ...
    if (examplesPopulated) {
      if (examples.singleTrackExample) {
        standardTrackFormatHelpTexts.push(
          `Single Track: ${examples.singleTrackExample}`
        );
      } else {
        standardTrackFormatErrors.push({
          message: 'Single Track: Invalid Format',
        });
      }

      if (examples.multiDiscTrackExample) {
        multiDiscTrackFormatHelpTexts.push(
          `Multi Disc Track: ${examples.multiDiscTrackExample}`
        );
      } else {
        multiDiscTrackFormatErrors.push({
          message: 'Single Track: Invalid Format',
        });
      }

      if (examples.artistFolderExample) {
        artistFolderFormatHelpTexts.push(
          `Example: ${examples.artistFolderExample}`
        );
      } else {
        ...
        {hasSettings && !isFetching && !error && (
          <Form>
            <FormGroup size={sizes.MEDIUM}>
              <FormLabel>{translate('RenameTracks')}</FormLabel>
            ...
            {renameTracks && (
              <div>
                <FormGroup size={sizes.LARGE}>
                  <FormLabel>{translate('StandardTrackFormat')}</FormLabel>
                  ...
                  <FormInputGroup
                    ...
                    buttons={
                      <FormInputButton
                        onPress={this.onStandardNamingModalOpenClick}
                      >
                        ?
                      </FormInputButton>
                    }
                    ...
                    errors={[
                      ...standardTrackFormatErrors,
                      ...settings.standardTrackFormat.errors,
                    ]}
                  />
                </FormGroup>

                <FormGroup size={sizes.LARGE}>
                  <FormLabel>{translate('MultiDiscTrackFormat')}</FormLabel>
                  ...
                  <FormInputGroup
                    ...
                    buttons={
                      <FormInputButton
                        onPress={this.onMultiDiscNamingModalOpenClick}
                      >
                        ?
                      </FormInputButton>
                    }
            ...
            <FormGroup advancedSettings={advancedSettings} isAdvanced={true}>
              <FormLabel>{translate('ArtistFolderFormat')}</FormLabel>
              ...
              <FormInputGroup
                ...
                buttons={
                  <FormInputButton
                    onPress={this.onArtistFolderNamingModalOpenClick}
                  >
                    ?
                  </FormInputButton>
                }
                ...
                helpTexts={[
                  'Used when adding a new artist or moving an artist via the artist editor',
                  ...artistFolderFormatHelpTexts,
                ]}
                errors={[
                  ...artistFolderFormatErrors,
                  ...settings.artistFolderFormat.errors,
                ]}
              />
            </FormGroup>
