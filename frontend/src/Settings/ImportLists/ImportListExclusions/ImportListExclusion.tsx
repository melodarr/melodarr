...
import styles from './ImportListExclusion.module.css';
...
class ImportListExclusion extends Component {
  ...
  render() {
    const { id, artistName, foreignId } = this.props;

    return (
      <div className={classNames(styles.importListExclusion)}>
        <div className={styles.artistName}>{artistName}</div>
        <div className={styles.foreignId}>{foreignId}</div>

        <div className={styles.actions}>
          <Link onPress={this.onEditImportListExclusionPress}>
        ...
        <EditImportListExclusionModalConnector
          ...
          onDeleteImportListExclusionPress={
            this.onDeleteImportListExclusionPress
          }
        />
