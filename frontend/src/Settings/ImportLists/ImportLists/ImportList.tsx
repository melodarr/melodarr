...
class ImportList extends Component {
  ...
  render() {
    const { id, name, enableAutomaticAdd, minRefreshInterval, shouldSearch } =
      this.props;
    ...
    return (
      ...
      >
        ...
        <div className={styles.enabled}>
          {enableAutomaticAdd && (
            <Label kind={kinds.SUCCESS}>Automatic Add</Label>
          )}

          {shouldSearch && <Label kind={kinds.SUCCESS}>Automatic Search</Label>}
        </div>

        <div className={styles.enabled}>
          <Label kind={kinds.INFO} title={translate('ListRefreshInterval')}>
