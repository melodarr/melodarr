...
class AddImportListItem extends Component {
  ...
  onImportListSelect = () => {
    const { implementation, implementationName, minRefreshInterval } =
      this.props;
  ...
  render() {
    ...
    return (
      <div className={styles.list}>
        <Link className={styles.underlay} onPress={this.onImportListSelect} />
        ...
        <div className={styles.overlay}>
          ...
          <div className={styles.actions}>
            {hasPresets && (
              <span>
                <Button size={sizes.SMALL} onPress={this.onImportListSelect}>
                  {translate('Custom')}
                </Button>
