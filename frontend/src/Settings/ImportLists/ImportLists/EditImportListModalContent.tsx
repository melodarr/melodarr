        ...
        {!isFetching && !error && (
          <Form {...otherProps}>
            ...
            <Alert kind={kinds.INFO} className={styles.message}>
              {translate('ListWillRefreshEveryInterp', [
                formatShortTimeSpan(minRefreshInterval.value),
              ])}
            </Alert>
            ...
            <FieldSet legend={translate('ImportListSettings')}>
              ...
              <FormGroup>
                <FormLabel>{translate('ShouldMonitorExisting')}</FormLabel>
              ...
              <FormGroup>
                <FormLabel>{translate('ShouldSearch')}</FormLabel>
            ...
            <FieldSet legend={translate('AddedArtistSettings')}>
              ...
              <FormGroup
                className={
                  showMetadataProfile ? undefined : styles.hideMetadataProfile
                }
              >
              ...
              <FormGroup>
                <FormLabel>{translate('LidarrTags')}</FormLabel>
