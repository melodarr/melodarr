    ...
    return (
      ...
      >
        ...
        {supportsOnReleaseImport && onReleaseImport ? (
          <Label kind={kinds.SUCCESS}>{translate('OnReleaseImport')}</Label>
        ) : null}
        ...
        {supportsOnTrackRetag && onTrackRetag ? (
          <Label kind={kinds.SUCCESS}>{translate('OnTrackRetag')}</Label>
        ) : null}

        {supportsOnArtistAdd && onArtistAdd ? (
          <Label kind={kinds.SUCCESS}>{translate('OnArtistAdd')}</Label>
        ) : null}

        {supportsOnArtistDelete && onArtistDelete ? (
          <Label kind={kinds.SUCCESS}>{translate('OnArtistDelete')}</Label>
        ) : null}

        {supportsOnAlbumDelete && onAlbumDelete ? (
          <Label kind={kinds.SUCCESS}>{translate('OnAlbumDelete')}</Label>
        ) : null}
        ...
        {supportsOnDownloadFailure && onDownloadFailure ? (
          <Label kind={kinds.SUCCESS}>{translate('OnDownloadFailure')}</Label>
        ) : null}

        {supportsOnImportFailure && onImportFailure ? (
          <Label kind={kinds.SUCCESS}>{translate('OnImportFailure')}</Label>
        ) : null}
