...
class Indexer extends Component {
  ...
  onCloneIndexerPress = () => {
    const { id, onCloneIndexerPress } = this.props;
    ...
    return (
      ...
      >
        ...
        <div className={styles.enabled}>
          {supportsRss && enableRss && <Label kind={kinds.SUCCESS}>RSS</Label>}

          {supportsSearch && enableAutomaticSearch && (
            <Label kind={kinds.SUCCESS}>Automatic Search</Label>
          )}

          {supportsSearch && enableInteractiveSearch && (
            <Label kind={kinds.SUCCESS}>Interactive Search</Label>
          )}

          {showPriority && (
            <Label kind={kinds.DEFAULT}>Priority: {priority}</Label>
          )}
