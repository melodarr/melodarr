...
class AddIndexerItem extends Component {
  ...
  onIndexerSelect = () => {
    const { implementation, implementationName } = this.props;
  ...
  render() {
    ...
    return (
      <div className={styles.indexer}>
        <Link className={styles.underlay} onPress={this.onIndexerSelect} />
        ...
        <div className={styles.overlay}>
          ...
          <div className={styles.actions}>
            {hasPresets && (
              <span>
                <Button size={sizes.SMALL} onPress={this.onIndexerSelect}>
                  {translate('Custom')}
                </Button>
