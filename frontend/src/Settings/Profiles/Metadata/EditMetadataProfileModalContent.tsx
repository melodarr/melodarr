...
import styles from './EditMetadataProfileModalContent.module.css';
...
function EditMetadataProfileModalContent(props) {
  const {
    ...
    isSaving,
    saveError,
    primaryAlbumTypes: _primaryAlbumTypes,
    secondaryAlbumTypes: _secondaryAlbumTypes,
    item,
    isInUse,
    onInputChange,
    onSavePress,
  ...
  return (
    <ModalContent onModalClose={onModalClose}>
      <ModalHeader>
        {id
          ? translate('EditMetadataProfile')
          : translate('AddMetadataProfile')}
      </ModalHeader>
      ...
      <ModalBody>
        ...
        {!isFetching && !!error && (
          <div>{translate('UnableToAddANewMetadataProfilePleaseTryAgain')}</div>
        )}
        ...
        {id && (
          <div
            ...
            title={
              isInUse
                ? translate(
                    'IsInUseCantDeleteAMetadataProfileThatIsAttachedToAnArtistOrImportList'
                  )
                : undefined
            }
          >
