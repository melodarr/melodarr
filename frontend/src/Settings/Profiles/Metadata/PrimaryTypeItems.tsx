...
import styles from './TypeItems.module.css';
...
class PrimaryTypeItems extends Component {
  ...
  render() {
    const { metadataProfileItems, errors, warnings, ...otherProps } =
      this.props;

    return (
      <FormGroup>
        <FormLabel>{translate('PrimaryTypes')}</FormLabel>
        <div>
