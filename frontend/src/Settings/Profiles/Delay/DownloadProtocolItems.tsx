...
import styles from './DownloadProtocolItems.module.css';
...
class DownloadProtocolItems extends Component {
  ...
  render() {
    const { dropIndex, dropPosition, items, errors, warnings, ...otherProps } =
      this.props;
    ...
    return (
      <FormGroup size={sizes.SMALL}>
        <FormLabel size={sizes.SMALL}>Download Protocols</FormLabel>

        <div>
          <FormInputHelpText text="Protocols higher in the list are more preferred. Only checked protocols are allowed" />
          ...
          >
            ...
            >
              <div className={styles.headerContainer}>
                <div className={styles.headerTitle}>Protocol</div>
                <div className={styles.headerDelay}>Delay (minutes)</div>
              </div>
