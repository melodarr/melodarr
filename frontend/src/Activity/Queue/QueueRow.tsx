...
class QueueRow extends Component {
  ...
  onRemoveQueueItemModalConfirmed = (blocklist, skipRedownload) => {
    const { onRemoveQueueItemPress, onQueueRowModalOpenOrClose } = this.props;
  ...
  render() {
    ...
    const { isRemoveQueueItemModalOpen, isInteractiveImportModalOpen } =
      this.state;
      ...
      <TableRow>
        ...
        {columns.map((column) => {
          ...
          if (name === 'quality') {
            return (
              <TableRowCell key={name}>
                {quality ? <TrackQuality quality={quality} /> : null}
              </TableRowCell>
            );
          }
          ...
          if (name === 'added') {
            return <RelativeDateCellConnector key={name} date={added} />;
          }
