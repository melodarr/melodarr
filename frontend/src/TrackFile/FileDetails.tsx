...
function renderRejections(rejections) {
  return (
    <span>
      <DescriptionListItemTitle>Rejections</DescriptionListItemTitle>
...
function FileDetails(props) {
  const { filename, audioTags, rejections } = props;
      ...
      <div className={styles.audioTags}>
        <DescriptionList>
          ...
          {audioTags.artistMBId !== undefined && (
            <Link to={`https://musicbrainz.org/artist/${audioTags.artistMBId}`}>
              <DescriptionListItem
          ...
          {audioTags.trackMBId !== undefined && (
            <Link to={`https://musicbrainz.org/track/${audioTags.trackMBId}`}>
              <DescriptionListItem
