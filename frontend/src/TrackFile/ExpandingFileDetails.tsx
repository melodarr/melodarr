...
import styles from './ExpandingFileDetails.module.css';
...
class ExpandingFileDetails extends Component {
  ...
  render() {
    const { filename, audioTags, rejections } = this.props;
    ...
    return (
      <div className={styles.fileDetails}>
        <div className={styles.header} onClick={this.onExpandPress}>
          ...
          <div className={styles.expandButton}>
            <Icon
              ...
              title={
                isExpanded
                  ? translate('IsExpandedHideFileInfo')
                  : translate('IsExpandedShowFileInfo')
              }
              size={24}
            />
          </div>
        ...
        {isExpanded && (
          <FileDetails audioTags={audioTags} rejections={rejections} />
        )}
      </div>
    );
  }
