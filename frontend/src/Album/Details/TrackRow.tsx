    ...
    return (
      <TableRow>
        {columns.map((column) => {
          ...
          if (name === 'medium') {
            return (
              <TableRowCell key={name} className={styles.trackNumber}>
                {mediumNumber}
              </TableRowCell>
            );
          }
          ...
          if (name === 'path') {
            return <TableRowCell key={name}>{trackFilePath}</TableRowCell>;
          }

          if (name === 'duration') {
            return (
              <TableRowCell key={name} className={styles.duration}>
