...
import styles from './TrackActionsCell.module.css';
...
class TrackActionsCell extends Component {
  ...
  render() {
    const { trackFileId, trackFilePath } = this.props;

    const { isDetailsModalOpen, isConfirmDeleteModalOpen } = this.state;
    ...
    return (
      <TableRowCell className={styles.TrackActionsCell}>
        ...
        {trackFilePath && (
          <IconButton name={icons.DELETE} onPress={this.onDeleteFilePress} />
        )}
