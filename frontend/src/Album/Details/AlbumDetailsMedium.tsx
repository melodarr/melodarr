...
import styles from './AlbumDetailsMedium.module.css';
...
class AlbumDetailsMedium extends Component {
  ...
  _expandByDefault() {
    const { mediumNumber, onExpandPress } = this.props;
  ...
  onExpandPress = () => {
    const { mediumNumber, isExpanded } = this.props;
  ...
  render() {
    ...
    const { trackCount, trackFileCount, totalTrackCount } =
        ...
        <div className={styles.header}>
          ...
          <Link className={styles.expandButton} onPress={this.onExpandPress}>
            <Icon
              ...
              title={
                isExpanded
                  ? translate('IsExpandedHideTracks')
                  : translate('IsExpandedShowTracks')
              }
              size={24}
            />
