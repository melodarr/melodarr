...
import styles from './DeleteAlbumModalContent.module.css';
...
class DeleteAlbumModalContent extends Component {
  ...
  render() {
    const { title, statistics = {}, onModalClose } = this.props;
    ...
    return (
      <ModalContent onModalClose={onModalClose}>
        ...
        <ModalBody>
          ...
          {deleteFiles && (
            <div className={styles.deleteFilesMessage}>
              <div>{translate('TheAlbumsFilesWillBeDeleted')}</div>

              {!!trackFileCount && (
                <div>
                  {trackFileCount} track files totaling{' '}
        ...
        <ModalFooter>
          ...
          <Button kind={kinds.DANGER} onPress={this.onDeleteAlbumConfirmed}>
            {translate('Delete')}
          </Button>
        </ModalFooter>
      </ModalContent>
