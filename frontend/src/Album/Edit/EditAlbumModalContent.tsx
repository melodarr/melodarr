...
class EditAlbumModalContent extends Component {
  ...
  render() {
    ...
    const { trackFileCount = 0 } = statistics;

    const { monitored, anyReleaseOk, releases } = item;
      ...
      <ModalContent onModalClose={onModalClose}>
        ...
        <ModalBody>
          <Form {...otherProps}>
            ...
            <FormGroup size={sizes.MEDIUM}>
              <FormLabel>{translate('AutomaticallySwitchRelease')}</FormLabel>
            ...
            <FormGroup size={sizes.MEDIUM}>
              <FormLabel>{translate('Release')}</FormLabel>
