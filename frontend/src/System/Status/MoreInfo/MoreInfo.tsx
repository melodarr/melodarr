      ...
      <FieldSet legend={translate('MoreInfo')}>
        <DescriptionList>
          ...
          <DescriptionListItemDescription>
            ...
            <Link to="https://github.com/melodarr/melodarr/wiki">
              github.com/melodarr/melodarr/wiki
            </Link>
          </DescriptionListItemDescription>
          ...
          <DescriptionListItemDescription>
            ...
            <Link to="https://github.com/melodarr/melodarr/discussions">
              github.com/melodarr/melodarr/discussions
            </Link>
          </DescriptionListItemDescription>
          ...
          <DescriptionListItemDescription>
            <Link to="https://github.com/melodarr/melodarr/issues">
              github.com/melodarr/melodarr/issues
            </Link>
          </DescriptionListItemDescription>
        </DescriptionList>
      </FieldSet>
