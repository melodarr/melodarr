      ...
      <PageContent title="Plugins">
        <PageContentBody>
          ...
          <FieldSet legend="Installed Plugins">
            {!isPopulated && !error && <LoadingIndicator />}

            {isPopulated && noPlugins && <div>No plugins are installed</div>}
