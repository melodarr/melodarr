...
namespace NzbDrone.Core.Test.Download.DownloadClientTests.TransmissionTests
{
    ...
    public class TransmissionFixture : TransmissionFixtureBase<Transmission>
    {
        ...
        public async Task Download_with_MusicDirectory_should_force_directory()
        {
            ...
            Mocker.GetMock<ITransmissionProxy>()
                  .Verify(v => v.AddTorrentFromData(It.IsAny<byte[]>(), @"C:/Downloads/Finished/Melodarr", It.IsAny<TransmissionSettings>()), Times.Once());
        }
        ...
        public async Task Download_with_category_should_force_directory()
        {
            ...
            Mocker.GetMock<ITransmissionProxy>()
                  .Verify(v => v.AddTorrentFromData(It.IsAny<byte[]>(), @"C:/Downloads/Finished/transmission/Melodarr", It.IsAny<TransmissionSettings>()), Times.Once());
        }
        ...
        public void should_exclude_items_not_in_category()
        {
            ...
            _downloading.DownloadDir = @"C:/Downloads/Finished/transmission/Melodarr";
        ...
        public void should_exclude_items_not_in_TvDirectory()
        {
            ...
            _downloading.DownloadDir = @"C:/Downloads/Finished/Melodarr/subdir";
