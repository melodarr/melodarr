...
{
    public class MelodarrListsParser : IParseImportListResponse
    {
        private readonly MelodarrListsSettings _settings;
        private ImportListResponse _importListResponse;

        public MelodarrListsParser(MelodarrListsSettings settings)
        {
            _settings = settings;
        }
        ...
        public IList<ImportListItemInfo> ParseResponse(ImportListResponse importListResponse)
        {
            ...
            var jsonResponse = JsonConvert.DeserializeObject<List<MelodarrListsAlbum>>(_importListResponse.Content);
