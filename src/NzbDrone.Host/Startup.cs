...
using System.Net;
using DryIoc;
using Melodarr.Api.V1.System;
using Melodarr.Http;
using Melodarr.Http.Authentication;
using Melodarr.Http.ClientSchema;
using Melodarr.Http.ErrorManagement;
using Melodarr.Http.Frontend;
using Melodarr.Http.Middleware;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddLogging(b =>
            {
                ...
                b.AddFilter("Melodarr.Http.Authentication.ApiKeyAuthenticationHandler", LogLevel.Information);
